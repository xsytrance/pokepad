/*
 * Poképad — Gen-III battle math (Kotlin), shared by the cross-gate and the
 * full Battle engine. A faithful port of sim/engine.py; validated bit-for-bit
 * against the Python spec by CrossGate.kt (fixtures/crossgate.tsv).
 */
